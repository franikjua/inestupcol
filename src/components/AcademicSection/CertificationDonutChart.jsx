...
import styles from "./CertificationDonutChart.module.css";

/**
 * Componente CertificationDonutChart
 ...
 */
const colors = ["#2A9D8F", "#E9C16A", "#645078", "#E76F51", "#F4A261", "#C8875F", "#919B9B", "#507DAF"];
