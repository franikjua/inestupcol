...
const menuItems = [
  {
    ...
    subMenus: [
      ...
      },
      {
        name: 'Docentes',
        items: [
          { label: 'Docentes Pregrado', path: '/academic/teaching' },
          { label: 'Docentes Posgrado', path: '/academic/teaching' },
          { label: 'Procedencia Docentes', path: '/academic/teaching' },
          { label: 'Condición Socioeconómica', path: '/academic/teaching' },
          { label: 'Formacion', path: '/academic/teaching' }
        ]
      },
      {
